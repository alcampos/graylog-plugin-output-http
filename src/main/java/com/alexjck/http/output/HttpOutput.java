...
public class HttpOutput implements MessageOutput {
    ...
    public HttpOutput(@Assisted Configuration configuration) throws MessageOutputConfigurationException {
        ...
        sender = new HttpSender(
                configuration.getString(API_HOST), configuration.getList(FIELD_LIST)
        );
    ...
    public static class Config extends MessageOutput.Config {
        ...
        public ConfigurationRequest getRequestedConfiguration() {
            ...
            configurationRequest.addField(new TextField(
                            API_HOST, "API Host", "",
                            "Hostname or IP address of the API instance",
                            ConfigurationField.Optional.NOT_OPTIONAL)
            );
            
            configurationRequest.addField(new ListField(
		                    FIELD_LIST, "Field list", Collections.emptyList(), Collections.emptyMap(),
		                    "Field list to pass to the api",
		                    ConfigurationField.Optional.NOT_OPTIONAL)
            );
    ...
    public static class Descriptor extends MessageOutput.Descriptor {
        public Descriptor() {
            super("HTTP Output", false, "", "Writes messages to your API via HTTP.");
        }
    }
